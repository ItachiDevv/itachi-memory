...
When changing a feature that is already documented (in README, docs/, CLAUDE.md, or any .md file in the repo), always update the relevant documentation to reflect the change.
