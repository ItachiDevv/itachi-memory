...
### API not reachable
- Test: `curl https://eliza-claude-production.up.railway.app/health`
- On Windows with TLS issues, use PowerShell: `Invoke-RestMethod -Uri 'https://eliza-claude-production.up.railway.app/health'`
